...
return [
    ...
    'btcpayserver' => [
        'text_payment_title' => 'BTCPayServer',
        'text_payment_desc' => 'Accept bitcoin on-chain / lightning payments though BTCPayServer',
        'btcpayserver_url' => 'BTCPayServer URL',
        'btcpayserver_api_key' => 'BTCPayServer API Key',
        'btcpayserver_store_id' => 'BTCPayServer Store ID',
    ],
